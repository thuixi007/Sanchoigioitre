...
public class activity_my_post extends AppCompatActivity {
    ...
    PostAdapter_my_post postAdapter;
...
////Lấy về giá trị truyền của tên tài khoản
        ...
        actionBar.setTitle("Bài viết của tôi");


        /// Thiết lập popup Thêm bài viết
        popAddpost = new Dialog(activity_my_post.this);
        ...
        popupAddbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!popupTitle.getText().toString().isEmpty()
                    ...
                    Toast.makeText(activity_my_post.this,"Bạn hãy điền đầy đủ tiêu đề, nội dung, và thêm hình ảnh nhé!",Toast.LENGTH_SHORT).show();
        ...
        bottomNavigationView.setSelectedItemId(R.id.nav_follow);
        ...
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    case R.id.nav_news:
                        startActivity(new Intent(activity_my_post.this, Blog_show.class).putExtra("tentaikhoan",tentaikhoan));
                        overridePendingTransition(0,0);
                        finish();
                        ActivityCompat.finishAffinity(activity_my_post.this);
                        //System.exit(0);

                        break;
                    case R.id.nav_forum:
                        startActivity(new Intent(activity_my_post.this, Forum_Main.class).putExtra("tentaikhoan",tentaikhoan));
                        overridePendingTransition(0,0);
                        finish();
                        ActivityCompat.finishAffinity(activity_my_post.this);
                        //System.exit(0);;
                    ...
                    case R.id.nav_account:
                        finish();
                        startActivity(new Intent(activity_my_post.this, activity_user_profile.class).putExtra("tentaikhoan",tentaikhoan));
                        overridePendingTransition(0,0);
    ...
    private void load_all_post() {
        ...
        CSDL.orderByChild("userId").equalTo(tentaikhoan).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                postAdapter = new PostAdapter_my_post(activity_my_post.this, postList );
    ...
    private void add_new_post(Post post, String fileName) {
        ...
        CSDL.push().setValue(post).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                ...
                Toast.makeText(activity_my_post.this,"Thêm bài viết thành công",Toast.LENGTH_SHORT).show();
